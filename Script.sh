...
curl --data "commentText=my%20forth%20comment%20on%20my%20first%20topic&commentPath=0" http://localhost:30975/post/comment
...
curl --data "commentText=my%20forth%20comment%20on%20my%20second%20topic&commentPath=1" http://localhost:30975/post/comment
...
curl --data "commentText=my%20forth%20comment%20on%20my%20third%20topic&commentPath=2" http://localhost:30975/post/comment
...
curl --data "commentText=my%20forth%20comment%20on%20my%20forth%20topic&commentPath=3" http://localhost:30975/post/comment
